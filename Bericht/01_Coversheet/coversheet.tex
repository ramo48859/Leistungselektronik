...
%
\def\title{Halbbrückenansteuerung\\(BootStrap)}
%
%
...
%
\def\name{Christian Niederl\\Christian Böhm\\David Märzinger\\Philip Kotek}
%
%
...
%
\def\institute{\raggedright Institut für elektrische\\ Antriebe und\\ Leistungselektronik}
%
%
...
%
\def\supervisor{Univ. Ass. \\DI Christoph Dobler}
\newif\ifsupvismale
\supvismaletrue
%\supvismalefalse
%
%\def\secondexaminer{Univ.-Prof. DI Dr.\\ Wolfgang Gruber}
\newif\ifsecexmale
\secexmaletrue
%\secexmalefalse
%
...
\ifeng
 \put(11.5,-2.5){\includegraphics[width=5.2cm]{01_Coversheet/images/jku_en}}
\else
 \put(11.5,-2.5){\includegraphics[width=5.2cm]{01_Coversheet/images/jku_de}}
\fi
...
\put(0,-17.2){\includegraphics[width=4.4cm]{01_Coversheet/images/arr}}
\put(0,-18.3){\begin{minipage}[t]{12cm}%
\ifeng
 {\large\ifcase\type Seminararbeit \or Diploma \or Master \fi}%
 \vskip 2mm%
 %
 \vskip 3mm%
 {\large\degree}
 \vskip 3mm%
  \ifcase\type  \or Diploma \or Master's \fi
\else
